...
# Make sure Ollama is running:  ollama serve  (starts automatically on most OS)
# ─────────────────────────────────────────────────────────────────────────────
...
def extract_fields(results: List[SearchResult],
    ...
    Usage:
        result = extract_fields(chunks, ["invoice_number", "vendor", "total"])
